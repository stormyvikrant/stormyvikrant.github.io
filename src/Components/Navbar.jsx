...
const Navbar = () => {
  ...
  return (
    <div className="flex justify-between items-center w-full px-4 h-20 text-black bg-yellow-100 fixed z-50">
      <div>
      ...
      <ul className="hidden md:flex">
        ...
        <li className="px-4 cursor-pointer capitalize font-medium text-black hover:scale-105 duration-200">
          <a href="/vikrantPrajapati_resume.pdf" download=''>Resume</a>
        </li>
      </ul>
