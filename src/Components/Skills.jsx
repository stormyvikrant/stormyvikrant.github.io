...
const Skills = () => {
  ...
  return (
    <div name="Skills" className="w-full bg-green-200">
      <div className="max-w-screen-lg mx-auto p-4 flex flex-col justify-center w-full">
        ...
        <div className="w-full md:grid md:grid-cols-2 md:auto-rows-auto gap-x-5 gap-y-5 mt-5">
          <div>
            <img
              src="https://github-readme-streak-stats.herokuapp.com/?user=stormyvikrant&theme=radical"
              alt="Github Streak"
            />
          </div>
          ...
          <div>
            <img
              src="https://github-readme-stats.vercel.app/api?username=stormyvikrant&theme=radical&count_private=true&show_icons=true"
              alt="github stats"
            />
          </div>
          ...
          <div>
            <img
              src="https://github-readme-stats.vercel.app/api/top-langs/?username=stormyvikrant&theme=radical"
              alt=""
            />
          </div>
        </div>
